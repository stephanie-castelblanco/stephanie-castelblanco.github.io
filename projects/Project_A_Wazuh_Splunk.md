...
<img src="screenshots/02-splunk-events.png" alt="Wazuh alerts arriving in Splunk">
...
<img src="screenshots/01-wazuh-manager-active.png" alt="Wazuh running">

**2. The alerts arrived in Splunk** — I searched and the security notes showed up.

<img src="screenshots/02-splunk-events.png" alt="Alerts in Splunk">

**3. The alert file exists** — proof Wazuh was writing down activity.

<img src="screenshots/03-alerts-json-exists.png" alt="Alert file exists">

**4. Alerts sorted by how serious they are** — low, medium, and higher-priority counts.

<img src="screenshots/04-rule-level-count.png" alt="Alerts by severity">

**5. The most common alerts** — logins, admin (sudo) use, and security check results.

<img src="screenshots/05-top-rule-descriptions.png" alt="Most common alerts">
